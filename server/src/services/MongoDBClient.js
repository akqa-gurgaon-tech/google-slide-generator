...
export class MongoDBClient {
    ...
    async saveDeck(pptJson, slidesArr, themes, userInfo) {
        ...
        if (existingDeck) {
            console.log(`🎯 MongoDB: Deck with ID ${pptJson.presentationId} exists. Updating slides...`);
    ...
    async cleanupDuplicateSlides(presentationId) {
        try {
